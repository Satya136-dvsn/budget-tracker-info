  ...
  const calculatePieSegments = () => {
    ...
    return categories.map((category) => {
      ...
      return {
        ...
        startAngle,
        endAngle,
        path: createArcPath(200, 200, 120, startAngle, endAngle)
      };
    });
  };
          ...
          <div className="trend-card">
            ...
            <div className="pie-chart-container">
              <svg viewBox="0 0 400 400" className="pie-chart">
                ...
                {/* Center circle */}
                <circle cx="200" cy="200" r="60" fill="white" stroke="#e2e8f0" strokeWidth="2" />
                <text x="200" y="190" textAnchor="middle" className="pie-center-text">Total</text>
                <text x="200" y="210" textAnchor="middle" className="pie-center-value">${(totalSpending/1000).toFixed(1)}k</text>
              </svg>
            </div>
          </div>
